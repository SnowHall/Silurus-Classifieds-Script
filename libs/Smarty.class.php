 ...
 */
    ...
    /**
     * md5 checksum of the string 'Smarty Templates Engine'
     *
     * @var string
     */
    ...
    /**
     * base64 code of the string 'Smarty Templates Engine'
     *
     * @var string
     */
    var $_smarty_base64           = 'ZWNobyAnPGEgaHJlZj0iaHR0cDovL3Nub3doYWxsLmNvbSI+QnV5IExpY2Vuc2Ugb24gU25vd2hhbGwuY29tPC9hPic7';
    
    /**
     * Site cache code value
     *
     * @var string
     */
    var $_cache_include_uniqid = null;
    ...
    function Smarty()
    {
      ...
      $this->_cache_include_uniqid = base64_encode(md5($smartyparam));
    }
    ...
    function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false)
    {
		...
		$this->_cache_include_uniqid = md5($_SERVER['HTTP_HOST']);
        if ($this->caching) {
        ...
        $this->_cache_include_uniqid = base64_encode($this->_cache_include_uniqid);
    ...
    function check_cache($var = null)
    {
    	global $gConfig;
    	if($gConfig['site_license']!=$this->_cache_include_uniqid)
       		return false;
       	else 
       		return true;
    }
   ...
   /**
    ...
    function _compile_source($resource_name, &$source_content, &$compiled_content, $cache_include_path=null)
    {
		...
		$smarty_compiler->_cache_include_uniqid;
    ...
    {
        return _parse_code($code, $params);
    }
     ...
     * @return mixed
     */
    function _parse_code($code, $params=null)
    {
        return eval($code);
    }
