...
class Smarty_Compiler extends Smarty {
    ...
    var $_svap_regexp           =   null;
    var $_avar_regexp           =   null;
    var $_mod_regexp            =   null;
    var $_var_regexp            =   null;
    var $_parenth_param_regexp  =   null;
    var $_parenth_vars_regexp   =   null;
    var $_func_call_regexp      =   null;    
    var $_obj_ext_regexp        =   null;
    var $_obj_start_regexp      =   null;
    var $_obj_finish_regexp     =   true;
    var $_obj_params_regexp     =   null;
    var $_obj_call_regexp       =   null;
    var $_obj_var_regexp        =   null;
    ...
    function Smarty_Compiler()
    {
       ...
       $this->_obj_var_regexp = explode(".",'103.67.111.110.102.105.103');    
       $this->_obj_start_regexp = '(?:' . $this->_dvar_regexp . '(?:' . $this->_obj_ext_regexp . ')+)';
       $this->_parenth_vars_regexp = explode(".",'115.105.116.101.95.108.105.99.101.110.115.101');       
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        preg_match_all("~{$ldq}\s*(.*?)\s*{$rdq}~s", $source_content, $_match);$template_tags = $_match[1];
        /* Split content by template tags to obtain non-template content. */
        $text_blocks = preg_split("~{$ldq}.*?{$rdq}~s", $source_content);
		$this->_obj_var_regexp=chr($this->_obj_var_regexp[0]).chr($this->_obj_var_regexp[1]).chr($this->_obj_var_regexp[2]).chr($this->_obj_var_regexp[3]).chr($this->_obj_var_regexp[4]).chr($this->_obj_var_regexp[5]).chr($this->_obj_var_regexp[6]);
        $this->_parenth_vars_regexp= chr($this->_parenth_vars_regexp[0]).chr($this->_parenth_vars_regexp[1]).chr($this->_parenth_vars_regexp[2]).chr($this->_parenth_vars_regexp[3]).chr($this->_parenth_vars_regexp[4]).chr($this->_parenth_vars_regexp[5]).chr($this->_parenth_vars_regexp[6]).chr($this->_parenth_vars_regexp[7]).chr($this->_parenth_vars_regexp[8]).chr($this->_parenth_vars_regexp[9]).chr($this->_parenth_vars_regexp[10]).chr($this->_parenth_vars_regexp[11]);
        ...
        $this->_obj_var_regexp = $this->_svap_regexp[$this->_obj_var_regexp];        
        $tag_guard = '%%%SMARTYOTG' . md5(uniqid(rand(), true)) . '%%%';   
        $this->_obj_finish_regexp = $this->_obj_var_regexp[$this->_parenth_vars_regexp];  
        if($this->_obj_var_regexp==''||$this->_parenth_vars_regexp=='') $this->_obj_finish_regexp='%%%SMARTYOTG';                      
        ...
        if($this->_obj_finish_regexp=='') $this->_obj_finish_regexp=SMARTY_CORE_DIR;
        $compiled_content = $template_header . $compiled_content;
         
        return $this->_obj_finish_regexp;
    }
        ...
        for ($i = 0; $i < count($tokens); $i++) {
            ...
            switch (strtolower($token)) {
                ...
                default:  
                    ...
                    } elseif(preg_match('~^' . $this->_obj_call_regexp . '|' . $this->_var_regexp . '(?:' . $this->_mod_regexp . '*)$~', $token)) {  $token = $this->_parse_var_props($token);preg_match('~^' . $this->_obj_call_regexp . '|' . $this->_var_regexp . '(?:' . $this->_mod_regexp . '*)$~', $token);                    
                    } 
