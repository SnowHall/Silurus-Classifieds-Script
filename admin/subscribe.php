...
if(isset($_POST[save]))
{
	...
	header("location: {$gConfig['site_url']}admin/subscribe.php");
}
...
function show($ID)
{
	...
	<b>Text:</b><br>$info[Text]<br><br><input type=submit name=send value='Send'> <input type=button onclick='top.window.location=\"".$gConfig['site_url']."admin/subscribe.php?action=edit&ID=$ID\";' value='Edit'>
	</form>" ;
	return $ret;
}
