...
function getList( $iArticleID = '' )
{
	...
	while($book = mysql_fetch_assoc($rElems))
	{
		...
		<td style="border:1px solid #cccccc;padding:3px;" valign=top>&nbsp;<a href="javascript:if(confirm(\'Delete?\')) window.location=\'/admin/reviews.php?del&ID='.$book['ID'].'\';">Del</a></td></tr>';		
	}
	$ret.='</table><br><br>'.$nav;
	return  $ret;
}
