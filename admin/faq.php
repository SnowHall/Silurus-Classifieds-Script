...
function getList( $iArticleID = '' )
{
	...
	$ret = '<a href="/admin/faq.php?action=add">Add question</a><br><br>
	<b>FAQ page preface</b><hr><table width=100%>';
	$q = mysql_query("select * from FAQ where ID=-2");
	$a = mysql_fetch_assoc($q);
	$ret.='<tr><td valign=top><b>'.$a['Title'].'</b></td><td valign=top><a href="/admin/faq.php?action=edit&ID='.$a['ID'].'">Edit</a></td></tr>';
	$q = mysql_query("select * from FAQ where ID=-1");
	$a = mysql_fetch_assoc($q);
	$ret.='<tr><td valign=top><b>'.$a['Title'].'</b></td><td valign=top><a href="/admin/faq.php?action=edit&ID='.$a['ID'].'">Edit</a><br><br></td></tr>
	<tr><td colspan=10><b>FAQ</b><hr></td></td>';
	
	$q = mysql_query("select * from FAQ where ID>0 order by ID");
	while($a = mysql_fetch_assoc($q))
	{
		$ret.='<tr><td valign=top><b>'.$a['Title'].'</b></td><td valign=top><a href="/admin/faq.php?action=edit&ID='.$a['ID'].'">Edit</a> &nbsp;&nbsp;&nbsp;<a href="/admin/faq.php?del&ID='.$a['ID'].'">Delete</a></td></tr>';
	}
	$ret.='</table>';
	return  $ret;
}
