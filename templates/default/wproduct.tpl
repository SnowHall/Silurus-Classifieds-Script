...
<table width="100%" cellpadding="0" cellspacing="0">
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0">
	    <tr>
		  <td valign="top">
		    ...
		    from <a href="wcategory.php?ID={$categ.ID}">{$categ.Title|escape:'html'}</a>
		    <br /><br />
		  ...
		  <td width="185px" valign="top" align="right">
		    <table width="100%" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
			    <td align="right">
		   		 <a href="wproduct.php?ID={$book.ID}&flag"><img src="{$template_path}img/flag_post.gif" border="0"/></a>
				</td>
			  </tr>
	...
	<td width="262px">
	  ...
	  <tr><td style="background:#e1e1e1">
		<table width="240px" cellpadding="0" cellspacing="0">
		  <tr>
		    <td>&nbsp;&nbsp;&nbsp;<span class="big_h3" style="color:#616161"><b>Buyer's Info</b></span></td>
			<td align="right"></td>
		  </tr>
		</table>
  ...
  <tr>
    <td>
      <div style="margin-top: 40px;" id="fb-root"></div><div class="fb-like" data-send="false" data-width="450" data-show-faces="true"></div>
    </td>
  </tr>
</table>
