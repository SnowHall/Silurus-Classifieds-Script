...
{if !$moderate_advertising || ($moderate_advertising && $book.status == '1') }
<table width="100%" cellpadding="0" cellspacing="0">
			...
			{if $tr2==0}
				<tr>
				  <td colspan="3" align="center">
				    <img src="{$gConfig.site_url}media/store/small_{$val.path}" width="120px" onmouseover="enable_zoom(this,{$val.width},{$photos[0].height});" onmouseout="disable_zoom();"/>
				  </td>
				</tr>
			{else}
				{if $tr==0}<tr>{/if}
				<td valign=top align="center">
				<img src="{$gConfig.site_url}media/store/small_{$val.path}"  width="30px" onmouseover="enable_zoom(this,{$val.width},{$val.height});" onmouseout="disable_zoom();"/>
				</td>
  ...
  {/if}
	  ...
	  <td style="background:url(/{$template_path}img/price2.gif);background-repeat:repeat-x;color:#d10f0f" nowrap><b>{$book.price|format_price}&nbsp;</b></td>
	...
	<td valign="top">
	  <table width="100%" cellpadding="0" cellspacing="0">
		  ...
		  <td width="185px" valign="top" align="right">
		    <table width="100%" cellpadding="0" cellspacing="0">
              ...
              {*if !$_SESSION.memberID}
                <tr>
                    <td align="right">
                        <a href="product.php?ID={$book.ID}&action=delete">Delete</a>&nbsp;&nbsp;&nbsp;
                        <a href="product.php?ID={$book.ID}&action=edit">Edit</a>
                    </td>
                </tr>
              {/if*}
			</table>
		...
		<tr>
		    <td colspan="2"><br /><br /><iframe src="http://www.facebook.com/plugins/like.php?href=http://{$smarty.server.SERVER_NAME}{$smarty.server.REQUEST_URI}&layout=button_count" scrolling="no" frameborder="0" style="border:none; width:450px; height:20px"></iframe></td>
		</tr>
	  </table>
...
{else}
    <p>Advertise will be show after moderate!</p>
{/if}
