	    ...
	    <tr>
		  <td width="350px">
		    <table cellpadding="0" cellspacing="0">
		      <tr>
		        <td rowspan="2">
		          <a href="/"><img src="/media/settings/logo.png" /></a>
		        </td>
		        <td valign="bottom">
				  ...
				  {foreach from=$recent item=oItem} 
				     <tr>
				      ...
				      <td width="60px" valign="center" align="center">				      
				        <span style="color:#cc0808;"><b>${$oItem.Price}</b></span><br>
...
{if !$memberID}
				...
				<form name="big_login_main" action="/member.php" method="POST">
				  <table width="80%" cellpadding="0" cellspacing="0">
					...
					<tr>
					  <td align="left" colspan="2" class="main_login_mail">
					    <br /><nobr><span class="big_h2"><b>Want to join?</b></span> 
...
{/if}
	  ...
	  <tr height="30px">
	    ...
	    {if $_GCONFIG.site_license==''}<span style="color:#2d4f94;font-size:13px;"> Powered by <a href="http://snowhall.com/silurus" style="color:#2d4f94;font-size:13px;">Silurus</a> &copy; <a href="http://snowhall.com" style="color:#2d4f94;font-size:13px;">SnowHall.com</a>  </span>{/if}
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    </td>
	  </tr>
	</table>
