		...
		<tr height="158px">
		  <td valign="center" width="330px"><br>
		    ...
		    <table  cellpadding="0" cellspacing="0">
		      <tr height="20px">
		        <td rowspan="2">
		          <a href="{$site_url}"><img src="{$template_path}img/p_logo.png" /></a>
		        </td>
		  ...
		  <td valign="top" align="right">
		   {if !$memberID}
				<form name="login_form" action="member.php" method="POST" target="top">
				  ...
				  <table>
				    ...
				    <tr>
					  ...
					  <tr>
					  <td width="10px"><a href="join_fb.php" class="f_reg"><img src="{$template_path}img/fb.png" /></a>
					  </td>
					  <td  align="left">
		    ...
		    {if $memberID}<br><br>
		      <span class="p_welcome"><b>Welcome, {if strlen($memberINFO.fname) || strlen($memberINFO.lname)}{$memberINFO.fname} {$memberINFO.lname}{else}{$memberINFO.NickName}{/if}!</b></span>&nbsp;&nbsp;<br><br>
              <a href="profile.php" style="color:#ffffff;font-size:12px">My account</a>&nbsp;&nbsp;
