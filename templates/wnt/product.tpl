...
{if !$moderate_advertising || ($moderate_advertising && $book.moderate) }
<table width="100%" cellpadding="0" cellspacing="0">
  ...
  {/if}
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0">
	  <tr>
	  <td style="background:#f00;color:#fff;padding:10px;" nowrap align="center"><b>${$book.price|escape:'html'}&nbsp;</b></td>
	  </tr>
	  </table>
  </td>
	<td width="20px">&nbsp;</td>
