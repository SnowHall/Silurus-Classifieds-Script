		  ...
		  <table width="100%" cellpadding="0" cellspacing="0">
		   ...
		   <tr>
			 ...
			 <td style="color:#000000;" valign="top">
			  <a href="mailto:{$user.Email}" style="color:#232323">{$user.Email}</a>
			 </td>
		   </tr>
		   <tr>
		     <td style="font-size:13px;" width="130px" valign="top">
	  ...
	  <div style="width:100%;">
		...
		<table width="95%" cellpadding="0" cellspacing="0">
		  <tr>
			...
			<td align="right">
        <a href="profile.php?ID={$user.ID}&flag"><img src="{$template_path}img/flag.gif" border="0"/></a>
      </td>
		  </tr>
		</table>
		{else}
		  ...
		  <table width="100%" cellpadding="0" cellspacing="0">
		   ...
		   {if $user.altemail!='' && !$user.altemail_none}
			<tr height="25px">
			  ...
			  <td valign="top">
			    <b><a href="mailto:{$user.altemail}" style="color:#232323;text-decoration:none;">{$user.altemail}</a></b>
			  </td>
			</tr>
		   {/if}
