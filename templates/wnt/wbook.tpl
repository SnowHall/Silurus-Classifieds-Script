	...
	<td width="285px">
	  ...
	  <div style="width:285px;background:#f0f0f0;padding-left:15px;padding-top:15px;">
		...
		<div style="padding:10px;">
		  <a href="profile.php?ID={$ap_seller.ID}" style="color:#b9b9b9;text-decoration:none;"><b>{$ap_seller.fname} {$ap_seller.lname}</b></a><br />
		  <img src="{$template_path}img/arr.gif" />&nbsp;
		  <a href="profile.php?ID={$ap_seller.ID}" style="color:#b9b9b9;text-decoration:none;font-size:11px;">Read My Profile</a><br /><br />
		  ...
		  <table width="100%" cellpadding="0" cellspacing="0">
		   ...
		   {if !$ap_seller.altemail_none}
			<tr height="25px">
			  ...
			  <td valign="top">
			    <b><a href="mailto:{$ap_seller.altemail}" style="color:#b9b9b9;text-decoration:none;">{$ap_seller.altemail}</a></b>
			  </td>
			</tr>
			{/if}
