...
<tr height="24px" class="table_title_tr">
  <td style="padding-left:15px;" nowrap>
    ...
    {/if}
    &nbsp;<a href="{$aBooks.cur_url}&{$aBooks.prefix}order=title{if !$aBooks.desc}&{$aBooks.prefix}desc{/if}#sale" class="table_title" style="color:#fff">Title</a>
  </td>
  <td width="15px">&nbsp;</td>
  <td nowrap>
    {if $aBooks.order=='date'}
    	{if $aBooks.desc}<img src="{$template_path}img/arr_up.png" />{else}<img src="{$template_path}img/arr_down.png" />{/if}
    {/if}
    &nbsp;<a href="{$aBooks.cur_url}&{$aBooks.prefix}order=date{if !$aBooks.desc}&{$aBooks.prefix}desc{/if}#sale" class="table_title"  style="color:#fff">Date Posted</a>
  </td>
  <td width="15px">&nbsp;</td>
  <td nowrap>
    {if $aBooks.order=='price'}
    	{if $aBooks.desc}<img src="{$template_path}img/arr_up.png" />{else}<img src="{$template_path}img/arr_down.png" />{/if}
    {/if}
    &nbsp;<a href="{$aBooks.cur_url}&{$aBooks.prefix}order=price{if !$aBooks.desc}&{$aBooks.prefix}desc{/if}#sale" class="table_title" style="color:#fff">Price</a>
  </td>
  <td width="15px">&nbsp;</td>
  <td nowrap>
    {if $aBooks.order=='quality'}
    	{if $aBooks.desc}<img src="{$template_path}img/arr_up.png" />{else}<img src="{$template_path}img/arr_down.png" />{/if}
    {/if}
    &nbsp;<a href="{$aBooks.cur_url}&{$aBooks.prefix}order=quality{if !$aBooks.desc}&{$aBooks.prefix}desc{/if}#sale" class="table_title" style="color:#fff">Category</a>
  </td>
...
<tr {if $oBook.featured == 1}class="featured"{/if} height="35px">
  ...
  <td style="border-bottom:1px solid #d5daf0">&nbsp;</td>
  <td class="black_text" nowrap style="border-bottom:1px solid #d5daf0">
    <span style="color:#d10f0f"><b>${$oBook.Price}</b></span>
  </td>
  <td style="border-bottom:1px solid #d5daf0">&nbsp;</td>
